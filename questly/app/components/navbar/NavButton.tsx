...
const signColors: Record<WitcherSign, string> = {
	igni: "after:from-red-500/80 after:via-red-400/40",
	axii: "after:from-green-500/80 after:via-green-400/40",
	aard: "after:from-cyan-500/80 after:via-cyan-400/40",
	yrden: "after:from-purple-500/80 after:via-purple-400/40",
