...
export function QuestImage({ src, completed, width }: Props) {
	return (
		<div className='relative flex items-center justify-center'>
			<div className='p-2 rounded-lg bg-zinc-900 border border-zinc-700'>
				<Image unoptimized width={1000} height={1000} src={src} className={`${width === "full" ? "h-12.5 w-12.5" : "h-12.5 w-8"} object-cover`} alt='location' />
			</div>
