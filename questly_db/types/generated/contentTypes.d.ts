...
export interface ApiQuestTypeQuestType extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'quest-types';
    singularName: 'quest-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRarityRarity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    game: Schema.Attribute.Relation<'oneToOne', 'api::game.game'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rarity.rarity'>;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
